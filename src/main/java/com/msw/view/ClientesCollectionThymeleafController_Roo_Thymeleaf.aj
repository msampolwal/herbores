...
privileged aspect ClientesCollectionThymeleafController_Roo_Thymeleaf {
    ...
    public void ClientesCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        ...
        if (columnName.equals("id")) {
            ...
            builder.addColumn(getMessageSource().getMessage("label_cliente_razonsocial", null, "Razon Social", locale), "razonSocial", String.class.getName(), 100);
        }
        else if (columnName.equals("documento")) {
            builder.addColumn(getMessageSource().getMessage("label_cliente_documento", null, "Documento", locale), "documento", String.class.getName(), 100);
        }
